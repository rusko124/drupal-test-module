...
class AjaxLoginSubmit
{
    ...
    public function ajaxSubmitCallback(array &$form, FormStateInterface $form_state)
    {
        ...
        if ($auth == true) {
            $ajax_response->addCommand(new HtmlCommand('#' . Html::getClass($form['form_id']['#value']) . '-messages', ' Hello, '.$form_state->getValue('name').'! To see the website as a registered user go to this link.' . $link_to_title));
